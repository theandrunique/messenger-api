...
public static partial class ApiErrors
{
    ...
    {
        public static BaseApiError InvalidCredentials
            => new BaseApiError(ErrorCode.AUTH_INVALID_CREDENTIALS, "Invalid credentials");

        public static BaseApiError SessionExpired
            => new BaseApiError(ErrorCode.AUTH_SESSION_EXPIRED, "Session expired");

        public static BaseApiError InvalidToken
            => new BaseApiError(ErrorCode.AUTH_INVALID_TOKEN, "Invalid token");

        public static BaseApiError InvalidCaptcha
            => new BaseApiError(ErrorCode.INVALID_CAPTCHA, "Invalid captcha");
        ...
        public static BaseApiError TotpRequired(Domain.Entities.User user)
            => new BaseApiError(
